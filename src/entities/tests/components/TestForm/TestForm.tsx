...
import { TCreateTestApiArg } from '@shared/api';
...
export const TestForm: FC<IProps> = ({ questions, isLoading, onValuesChange, form }) => (
  <Form form={form} layout="vertical" onValuesChange={(_, values) => onValuesChange?.(values)}>
    <Form.Item label="Название теста" name="title" rules={[{ required: true, message: 'Введите название теста' }]}>
