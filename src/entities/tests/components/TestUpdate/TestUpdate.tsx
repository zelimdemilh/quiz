...
import { TCreateTestApiArg, useGetAllQuestionsQuery, useUpdateTestMutation } from '@shared/api';
...
export const TestUpdate: FC<IProps> = ({ test }) => {
  ...
  return (
    <>
      ...
      >
        <TestForm questions={questions!} form={form} isLoading={isLoading} onValuesChange={setFormData} />
      </Modal>
    </>
  );
};
