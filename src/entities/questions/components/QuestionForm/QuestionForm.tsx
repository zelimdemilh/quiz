...
import { TCreateQuestionApiArg } from '@shared/api';
...
export const QuestionForm: FC<IProps> = ({ question, form, onValuesChange }) => {
          ...
          <>
            {fields.map(({ key, name, ...restField }) => (
              <Space key={key} style={{ display: 'flex', marginBottom: 8 }} align="baseline">
                <Form.Item {...restField} name={[name]} rules={[{ required: true, message: 'Введите вариант ответа' }]}>
